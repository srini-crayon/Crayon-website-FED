  ...
  useEffect(() => {
    if (agentDetails?.agent && isEditMode) {
      ...
      setFormData({
        ...
        tags: agentData.tags || '',
        roi: agentData.roi || '',
        demo_link: agentData.demo_link || agentData.application_demo_url || '',
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              <div>
                ...
                <Tabs defaultValue="features" className="w-full mt-[100px]">
                  {(agentData.demo_link || agentData.application_demo_url) && (
                    <div className="mb-6 flex justify-center">
                      {isEditMode ? (
                        ...
                        <a
                          href={agentData.demo_link || agentData.application_demo_url}
                          target="_blank"
                          rel="noreferrer"
                          style={{
                  ...
                  <TabsContent value="roi" className="mt-6">
                    {isEditMode ? (
                      <Textarea
                        ...
                        className="min-h-[120px] border focus:border-blue-500 focus:ring-blue-500 resize-y"
                        placeholder="Enter ROI information (one per line or separated by semicolons)"
                      />
