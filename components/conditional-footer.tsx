...
export function ConditionalFooter() {
  ...
  // Use crayon-footer on crayondata, tangram-ai, tangram-ai-isv, tangram-ai-reseller, blog, podcast, privacy-policy, cookie-policy, security-policy, terms-of-use, trust-center, privacy-civil-liberties, our-story, our-investors, our-values, vision, our-team, career, enquiry, agents-store, and x pages
