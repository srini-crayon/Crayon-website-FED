...
export const endpoints = {
  ...
  wishlists: {
    ...
    getPublic: (slug: string) => `/api/wishlists/public/${slug}`, // Public endpoint with full agent details
    update: (id: string) => `/api/wishlists/${id}`,
    delete: (id: string) => `/api/wishlists/${id}`,
    addAgent: (id: string) => `/api/wishlists/${id}/agents`,
    removeAgent: (id: string, agentId: string) => `/api/wishlists/${id}/agents/${agentId}`,
  },
} as const
