...
import { AgentActionButtons } from "../../../components/agent-action-buttons"
    ...
    <>
      ...
      <section className="relative py-12">
        ...
        <div className="w-full px-8 md:px-12 lg:px-16 mx-auto" style={{ maxWidth: "1407px" }}>
          ...
          <AgentActionButtons
            agentId={data?.agent?.agent_id || id}
            agentName={data?.agent?.agent_name}
            demoLink={data?.agent?.demo_link || data?.agent?.application_demo_url}
          />
        </div>
      </section>
